...
export const Icons = {
  ...
  Sprout: (props: IconProps) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21V12M12 12C12 9.79 13.79 8 16 8C18.21 8 20 9.79 20 12H12M12 12C12 9.79 10.21 8 8 8C5.79 8 4 9.79 4 12H12" />
    </svg>
  ),

  Droplet: (props: IconProps) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21.5c-3.5 0-6-2.5-6-6 0-4 6-11 6-11s6 7 6 11c0 3.5-2.5 6-6 6z" />
    </svg>
  ),
  ...
  Microscope: (props: IconProps) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 21h12M9 21v-4M15 21v-4M12 17a5 5 0 100-10 5 5 0 000 10zM12 3v4M17.5 8.5l-3.5 3.5" />
    </svg>
  ),
};
